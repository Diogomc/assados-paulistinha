        ...
        <div>
            ...
            <div className="flex justify-center items-center max-md:flex-col my-30 max-md:my-0">
                <div className=" text-center max-md:w-full">
                    <img className="w-150 h-[400px] p-2 max-md:object-contain max-md:h-full" src="/costela.jpg" alt="" />
                ...
                <div className=" text-center  max-md:w-full">
                    <img className="w-150 h-[400px] p-2 max-md:object-contain max-md:h-full" src="/frangoAssado.jpg" alt="" />
